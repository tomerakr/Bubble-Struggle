...
public:
	...
	int getIndex() const				{ return m_index; } //to know color in level creator
	...
	const b2Vec2& getForce() const		{ return m_body->GetLinearVelocity(); }
	void destroy();
	bool destroied() const				{ return m_destroy; }
	void creatingNewBall()				{ m_hadChild = true; } //for survival

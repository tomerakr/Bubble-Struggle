	...
	:m_level(1)
{
	...
	m_levelText.setPosition(sf::Vector2f(windowWitdh / 2, windowHieght - barHeight + 30));

	m_scoreText.setCharacterSize(textBarSize);
	m_scoreText.setFont(*Resources::instance().getFont());
	m_scoreText.setFillColor(sf::Color::Black);
	m_scoreText.setPosition(sf::Vector2f(windowWitdh / 2 - 60, windowHieght - barHeight + 30));
...
void Bar::draw(sf::RenderWindow& window, Bear& bear)
{
	...
	{
		m_lifeIcon.setPosition(sf::Vector2f(20 + i * 60  ,windowHieght - barHeight + 30));
